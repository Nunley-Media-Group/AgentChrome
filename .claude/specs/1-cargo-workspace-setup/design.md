...
repository = "https://github.com/rnunley-nmg/agentchrome"
...
|--------|-------------|------|------|----------|
| **A: Multi-crate workspace** | Split into `agentchrome` and `agentchrome-core` from the start | Clean separation early | Premature — no code to separate yet | Rejected — split when needed |
