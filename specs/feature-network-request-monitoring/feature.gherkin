...
Feature: Network request monitoring
  ...
  Scenario: List network requests targeting a specific tab
    ...
    When I run "agentchrome network list --tab <TAB_ID>"
  ...
  Scenario Outline: Filter by resource type
    ...
    When I run "agentchrome network list --type <types>"
  ...
  Scenario: Get detailed network request info
    ...
    When I run "agentchrome network get <REQ_ID>"
  ...
  Scenario: Save request body to file
    ...
    When I run "agentchrome network get <REQ_ID> --save-request /tmp/req.txt"
  ...
  Scenario: Save response body to file
    ...
    When I run "agentchrome network get <REQ_ID> --save-response /tmp/resp.json"
  ...
  Scenario: Follow with type and method filters
    Given a page is open
    When I run "agentchrome network follow --type xhr --method POST --timeout 5000"
  ...
  Scenario: Follow with URL filter
    Given a page is open
    When I run "agentchrome network follow --url api/ --timeout 5000"
  ...
  Scenario: Follow exits after timeout
    When I run "agentchrome network follow --timeout 2000"
    Then the command exits after approximately 2 seconds
    And the exit code should be 0

  Scenario: Follow exits on Ctrl+C
    When I start "agentchrome network follow"
  ...
  Scenario: Follow verbose mode includes headers
    Given a page is open
    When I run "agentchrome network follow --verbose --timeout 5000"
