...
**When** I run `agentchrome network list --tab <ID>`
...
**When** I run `agentchrome network list --type xhr,fetch`
...
**When** I run `agentchrome network list --url "api.example.com"`
...
**When** I run `agentchrome network list --status 404`
**Then** only requests with HTTP status 404 are returned

### AC6: Filter by HTTP status code (wildcard)

**Given** Chrome is running with a page that has responses with various status codes
**When** I run `agentchrome network list --status 4xx`
...
**When** I run `agentchrome network list --include-preserved`
...
**When** I run `agentchrome network get 5`
...
**When** I run `agentchrome network get <ID>`
...
**When** I run `agentchrome network get <ID> --save-request /tmp/req.txt`
...
**When** I run `agentchrome network get <ID> --save-response /tmp/resp.json`
...
**When** I run `agentchrome network follow`
...
**Given** Chrome is running with a page open
**When** I run `agentchrome network follow --type xhr --method POST`
...
**Given** Chrome is running with a page open
**When** I run `agentchrome network follow --url "api/"`
...
**Given** Chrome is running with a page open
**When** I run `agentchrome network follow --timeout 5000`
**Then** the stream exits automatically after 5 seconds

### AC20: Follow exits on Ctrl+C

**Given** Chrome is running and `agentchrome network follow` is active
...
**Given** Chrome is running with a page open
**When** I run `agentchrome network follow --verbose`
...
**When** I run `agentchrome network get 99999`
