...
**When** I run `agentchrome page text`
...
**When** I run `agentchrome page text --tab <ID>`
...
**When** I run `agentchrome page text --plain`
...
**Given** Chrome is running with a page loaded
**When** I run `agentchrome page text --pretty`
