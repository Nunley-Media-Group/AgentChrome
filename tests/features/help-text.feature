...
Feature: Comprehensive help text
  ...
  Scenario: Top-level help includes quick-start examples
    ...
    And stdout should contain "agentchrome connect"
    And stdout should contain "agentchrome tabs list"
  ...
  Scenario: Top-level help documents environment variables
    ...
    And stdout should contain "AGENTCHROME_TIMEOUT"
  ...
  Scenario: Tabs group help includes usage examples
    ...
    And stdout should contain "agentchrome tabs"

  Scenario: Navigate group help includes usage examples
    Given agentchrome is built
    When I run "agentchrome navigate --help"
    Then stdout should contain "EXAMPLES"
    And stdout should contain "agentchrome navigate"

  Scenario: Page group help includes usage examples
    Given agentchrome is built
    When I run "agentchrome page --help"
    Then stdout should contain "EXAMPLES"
    And stdout should contain "agentchrome page"

  Scenario: Js group help includes usage examples
    Given agentchrome is built
    When I run "agentchrome js --help"
    Then stdout should contain "EXAMPLES"
    And stdout should contain "agentchrome js"

  Scenario: Console group help includes usage examples
    Given agentchrome is built
    When I run "agentchrome console --help"
    Then stdout should contain "EXAMPLES"
    And stdout should contain "agentchrome console"

  Scenario: Network group help includes usage examples
    Given agentchrome is built
    When I run "agentchrome network --help"
    Then stdout should contain "EXAMPLES"
    And stdout should contain "agentchrome network"

  Scenario: Interact group help includes usage examples
    Given agentchrome is built
    When I run "agentchrome interact --help"
    Then stdout should contain "EXAMPLES"
    And stdout should contain "agentchrome interact"

  Scenario: Form group help includes usage examples
    Given agentchrome is built
    When I run "agentchrome form --help"
    Then stdout should contain "EXAMPLES"
    And stdout should contain "agentchrome form"

  Scenario: Emulate group help includes usage examples
    Given agentchrome is built
    When I run "agentchrome emulate --help"
    Then stdout should contain "EXAMPLES"
    And stdout should contain "agentchrome emulate"

  Scenario: Perf group help includes usage examples
    Given agentchrome is built
    When I run "agentchrome perf --help"
    Then stdout should contain "EXAMPLES"
    And stdout should contain "agentchrome perf"

  Scenario: Dialog group help includes usage examples
    Given agentchrome is built
    When I run "agentchrome dialog --help"
    Then stdout should contain "EXAMPLES"
    And stdout should contain "agentchrome dialog"

  Scenario: Config group help includes usage examples
    Given agentchrome is built
    When I run "agentchrome config --help"
    Then stdout should contain "EXAMPLES"
    And stdout should contain "agentchrome config"
  ...
  Scenario: tabs create help includes examples
    Given agentchrome is built
    When I run "agentchrome tabs create --help"
    Then stdout should contain "EXAMPLES"

  Scenario: tabs close help includes examples
    Given agentchrome is built
    When I run "agentchrome tabs close --help"
    Then stdout should contain "EXAMPLES"

  Scenario: tabs activate help includes examples
    Given agentchrome is built
    When I run "agentchrome tabs activate --help"
    Then stdout should contain "EXAMPLES"

  Scenario: navigate back help includes examples
    Given agentchrome is built
    When I run "agentchrome navigate back --help"
    Then stdout should contain "EXAMPLES"

  Scenario: navigate forward help includes examples
    Given agentchrome is built
    When I run "agentchrome navigate forward --help"
    Then stdout should contain "EXAMPLES"

  Scenario: navigate reload help includes examples
    Given agentchrome is built
    When I run "agentchrome navigate reload --help"
    Then stdout should contain "EXAMPLES"

  Scenario: page text help includes examples
    Given agentchrome is built
    When I run "agentchrome page text --help"
    Then stdout should contain "EXAMPLES"
  ...
  Scenario: page find help includes examples
    Given agentchrome is built
    When I run "agentchrome page find --help"
    Then stdout should contain "EXAMPLES"

  Scenario: page screenshot help includes examples
    Given agentchrome is built
    When I run "agentchrome page screenshot --help"
    Then stdout should contain "EXAMPLES"

  Scenario: page resize help includes examples
    Given agentchrome is built
    When I run "agentchrome page resize --help"
    Then stdout should contain "EXAMPLES"

  Scenario: js exec help includes examples
    Given agentchrome is built
    When I run "agentchrome js exec --help"
    Then stdout should contain "EXAMPLES"
  ...
  Scenario: network list help includes examples
    Given agentchrome is built
    When I run "agentchrome network list --help"
    Then stdout should contain "EXAMPLES"

  Scenario: network get help includes examples
    Given agentchrome is built
    When I run "agentchrome network get --help"
    Then stdout should contain "EXAMPLES"

  Scenario: network follow help includes examples
    Given agentchrome is built
    When I run "agentchrome network follow --help"
    Then stdout should contain "EXAMPLES"
  ...
  Scenario: interact hover help includes examples
    Given agentchrome is built
    When I run "agentchrome interact hover --help"
    Then stdout should contain "EXAMPLES"

  Scenario: interact drag help includes examples
    Given agentchrome is built
    When I run "agentchrome interact drag --help"
    Then stdout should contain "EXAMPLES"
