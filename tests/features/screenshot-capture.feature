...
Feature: Screenshot capture
  ...
  Scenario: Capture viewport screenshot (default)
    ...
    When I run "agentchrome page screenshot"
  ...
  Scenario: Save screenshot to file
    Given a page is loaded at "https://example.com"
    When I run "agentchrome page screenshot --file /tmp/test-screenshot.png"
  ...
  Scenario: Target a specific tab
    ...
    When I run "agentchrome page screenshot --tab <ID>"
  ...
  Scenario: Element screenshot by CSS selector
    ...
    When I run "agentchrome page screenshot --selector '#logo'"
  ...
  Scenario: Element screenshot by accessibility UID
    ...
    When I run "agentchrome page screenshot --uid s1"
  ...
  Scenario: JPEG format
    ...
    When I run "agentchrome page screenshot --format jpeg"
    Then the "format" field is "jpeg"

  Scenario: WebP format
    Given a page is loaded
    When I run "agentchrome page screenshot --format webp"
    Then the "format" field is "webp"

  Scenario: Custom quality for JPEG
    Given a page is loaded
    When I run "agentchrome page screenshot --format jpeg --quality 50"
  ...
  Scenario: Region clipping
    Given a page is loaded
    When I run "agentchrome page screenshot --clip 10,20,200,100"
  ...
  Scenario: Quality ignored for PNG format
    Given a page is loaded
    When I run "agentchrome page screenshot --format png --quality 50"
