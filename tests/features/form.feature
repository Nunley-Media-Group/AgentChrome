...
Feature: Form input and filling
  ...
  Scenario: Clear requires a target argument
    Given agentchrome is built
    When I run "agentchrome form clear"
    Then the exit code should be nonzero
    And stderr should contain "required"
  ...
  #   When I run "agentchrome form fill s1 'John Doe'"
  #   Then the exit code should be 0
  ...
  #   When I run "agentchrome form fill s4 'Multi-line text content'"
  #   Then the exit code should be 0
  ...
  #   Given Chrome is running with CDP enabled
  #   And an accessibility snapshot has been taken with UIDs assigned
  #   When I run "agentchrome form fill s1 'Jane' --include-snapshot"
  #   Then the exit code should be 0
  ...
  #   Given Chrome is running with CDP enabled
  #   And an accessibility snapshot has been taken with UIDs assigned
  #   When I run "agentchrome form fill-many '[{\"uid\":\"s1\",\"value\":\"John\"}]' --include-snapshot"
  #   Then the exit code should be 0
  #   And the output JSON should contain a "snapshot" object
  ...
  #   Given Chrome is running with CDP enabled
  #   And an accessibility snapshot has been taken with UIDs assigned
  #   When I run "agentchrome form fill s1 'test'"
  ...
  #   When I run "agentchrome form fill s1 'value' --tab TAB_ID"
  #   Then the exit code should be 0
  ...
  Scenario: fill-many with --json flag does not panic
    Given agentchrome is built
    When I run "agentchrome form fill-many '[{\"uid\":\"s1\",\"value\":\"test\"}]' --json"
    Then the exit code should not be 101
