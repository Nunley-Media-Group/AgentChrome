...
Feature: README documentation
  As a developer discovering agentchrome for the first time
  ...
  Scenario: Header with project name and description
    ...
    Then it starts with a level-1 heading containing "agentchrome"
  ...
  Scenario: Usage examples cover common workflows
    ...
    Then it contains a screenshot example with "agentchrome page screenshot"
    And it contains a text extraction example with "agentchrome page text"
    And it contains a JavaScript execution example with "agentchrome js exec"

  Scenario: Usage examples include form and network workflows
    When I read the "Usage" section
    Then it contains a form filling example with "agentchrome form"
    And it contains a network monitoring example with "agentchrome network"
  ...
  Scenario: Command reference directs to detailed help
    When I read the "Command Reference" section
    Then it mentions "agentchrome <command> --help" or "man" for detailed usage
